<aside class="admin-sidebar">
    ...
    <?php $user = \App\Core\Auth::currentUser(); ?>
    <?php if ($user && $user['role'] === 'student'): ?>
        <div class="sidebar-heading">My Account</div>
        <ul class="sidebar-nav">
            <li><a href="/profile" class="<?= $uri === '/profile' ? 'active' : '' ?>">My Profile</a></li>
            <li><a href="/bookmarks" class="<?= $uri === '/bookmarks' ? 'active' : '' ?>">Bookmarks</a></li>
            <li><a href="/archived" class="<?= $uri === '/archived' ? 'active' : '' ?>">Archived</a></li>
        </ul>
    <?php else: ?>
